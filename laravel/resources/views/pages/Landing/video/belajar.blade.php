                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                    <div class="flex justify-center px-4 py-2">
                        <a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" data-lity>
                            <img src="{{ asset('/assets/images/video/video-1.png') }}" style="height: 170px" alt="">
                            <div class="text-left py-2">
                                <p class="text-base font-normal"> AVL Tree</p>
                            </div>
                        </a>
                    </div>
                    <div class="flex justify-center px-4 py-2">
                        <a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" data-lity>
                            <img src="{{ asset('/assets/images/video/video-2.png') }}" style="height: 170px" alt="">
                            <div class="text-left py-2">
                                <p class="text-base font-normal"> AVL Tree</p>
                            </div>
                        </a>
                    ...
                    <div class="flex justify-center px-4 py-2">
                        <a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" data-lity>
                            <img src="{{ asset('/assets/images/video/video-3.png') }}" style="height: 170px" alt="">
                            <div class="text-left py-2">
                                <p class="text-base font-normal"> AVL Tree</p>
