                                ...
                                <div class="px-4 py-5 sm:p-6">
                                    <div class="grid grid-cols-6 gap-6">
                                        ...
                                        <div class="col-span-6">
                                            ...
                                            <input placeholder="Title" type="text" name="title" id="title" autocomplete="title" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" value="{{ $banksoal->title }}" required>
                                        ...
                                        <div class="col-span-6">
                                            ...
                                            <input placeholder="soal" type="file" name="soal" id="soal" autocomplete="soal" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" value="{{ old('soal') }}" required>
                                        ...
                                        <div class="col-span-6">
                                            ...
                                            <input placeholder="jawaban" type="file" name="jawaban" id="jawaban" autocomplete="jawaban" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" value="{{ old('soal') }}" required>
