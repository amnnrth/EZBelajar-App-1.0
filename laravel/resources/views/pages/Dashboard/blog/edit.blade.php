                            ...
                            <div class="">
                                <div class="px-4 py-5 sm:p-6">
                                    <div class="grid grid-cols-6 gap-6">
                                        ...
                                        <div class="col-span-6">
                                            <label for="iamgePath" class="block mb-3 font-medium text-gray-700 text-md">Cover</label>
                                        ...
                                        <div class="col-span-6">
                                            ...
                                            <input placeholder="body" type="text" name="body" id="body" autocomplete="body" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" value="{{ $belajar->link }}" required>
...
{{--                                        <div class="col-span-6">--}}
{{--                                            <label for="imagePath" class="block mb-3 font-medium text-gray-700 text-md">Cover Image</label>--}}
